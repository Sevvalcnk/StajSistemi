...
{
    /// <inheritdoc />
    public partial class SonSavasInitial : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "AspNetUsers",
                columns: new[] { "Id", "AccessFailedCount", "ConcurrencyStamp", "DepartmentId", "Email", "EmailConfirmed", "FirstName", "FullName", "IPAddress", "LastName", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "StudentNo", "TwoFactorEnabled", "UserName" },
                values: new object[] { 1, 0, "67f1b62f-1fd9-44fa-9f74-81d524ec28e1", null, "admin@stajsistemi.com", true, "Süper", "Süper Admin", null, "Admin", false, null, "ADMIN@STAJSISTEMI.COM", "ADMIN", "AQAAAAIAAYagAAAAEAm0u5fr4oNg8K1iP19KN5PBFCBgBBp7/HssVTHWx89T1YKbPaL+o4LX7ZtggvQwrA==", null, false, "", null, false, "admin" });
