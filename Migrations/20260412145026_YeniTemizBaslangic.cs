...
{
    /// <inheritdoc />
    public partial class YeniTemizBaslangic : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MinGPA = table.Column<decimal>(type: "decimal(3,2)", precision: 3, scale: 2, nullable: false),
                    CityId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<int>(type: "int", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    StudentIP = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_DailyReports_InternshipApplications_InternshipApplicationId",
            ...
            migrationBuilder.CreateTable(
                name: "InternshipApplicationLogs",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InternshipApplicationLogs", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 3, null, "Advisor", "ADVISOR" }
                });

            migrationBuilder.InsertData(
                table: "AspNetUsers",
                columns: new[] { "Id", "AcademicYear", "AccessFailedCount", "AdvisorId", "BirthDate", "BirthPlace", "CVPath", "CertificatePath", "CityId", "CompanyName", "CompanySector", "CompanyTaxNumber", "ConcurrencyStamp", "DepartmentId", "DepartmentName", "EducationSummary", "Email", "EmailConfirmed", "FacultyName", "FirstName", "FullName", "GPA", "IPAddress", "IsDeleted", "LastName", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PersonalSkills", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "StudentNo", "TwoFactorEnabled", "UniversityName", "UserName" },
                values: new object[] { 1, "2025-2026", 0, null, null, null, null, null, null, null, null, null, "ab641e33-11dc-4bfc-9839-e7ec985be37b", null, "Yönetim Paneli", null, "admin@stajsistemi.com", true, "Ayancık Meslek Yüksekokulu", "Süper", "Süper Admin", null, null, false, "Admin", false, null, "ADMIN@STAJSISTEMI.COM", "ADMIN", "AQAAAAIAAYagAAAAEBgTCVOuinZcKJQx6JH5g9c/qGM3Og3kDZSaPDvYhMFEmioBBy9xEuDqkmWwWXQ9Zg==", null, null, false, "6fd30a90-5f95-4eba-9dea-1c4dc7e32f52", null, false, "Sinop Üniversitesi", "admin" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DailyReports_InternshipApplicationId",
                table: "DailyReports",
